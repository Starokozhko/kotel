<div class="container">
    <div class=" col">
        <section class="categories-m">
            <?php $fields = get_row(true); ?>
            <?php if ($fields['sub_title']): ?>
                <p class="categories-m__sub-title"><b><?= $fields['sub_title']; ?></b></p>
            <?php endif; ?>
            <?php if ($fields['title']): ?>
                <h2 class="categories-m__title"><?= $fields['title']; ?></h2>
            <?php endif; ?>

            <?php if ($fields['description']): ?>
                <p class="categories-m__description"><?= $fields['description'] ?></p>
            <?php endif; ?>

            <?php if (have_rows('categories_list')): ?>
                <div class="categories-m__list">
                    <?php while (have_rows('categories_list')): the_row(); ?>
                        ...
                        <div class="categories-m__item">
                            ...
                            <div class="categories-m__item-info">
                                <?php if ($category && !is_wp_error($category) && !is_wp_error($category_link)): ?>
                                    <a href="<?= esc_url($category_link); ?>" class="categories-m__cat-title">
